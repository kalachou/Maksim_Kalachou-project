...
export class CalculatorComponent implements OnInit {
  ...
  calculate() {
  	...
  	this.targetValue = +(this.initialValue * initialCurrencyRate.Cur_OfficialRate / initialCurrencyRate.Cur_Scale / targetCurrencyRate.Cur_OfficialRate * targetCurrencyRate.Cur_Scale).toFixed(4);
